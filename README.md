...
| P4 | Integrations & templates: Google Calendar, Home Assistant, clinic queue | ▶ shipped (token apps, OAuth + Google Calendar, Home Assistant, public share links); more templates next |
