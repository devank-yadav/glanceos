...
export const BLOCKS: BlockDef[] = [
  ...
  { type: "button", label: "Chip", glyph: "▢", category: "Text", defaultH: 2, description: "A static labelled chip (the wall is read-only — run automations from your phone or the API)", keywords: "chip pill label tag badge button", defaultProps: { label: "Label" } },
  // #66 — read-only by nature: the wall shows the code, the phone scans and acts.
  { type: "qrCode", label: "QR code", glyph: "▩", category: "Media", defaultH: 8, description: "A scannable code — a link, Wi-Fi, a ticket. Bind its value to make it live.", keywords: "qr scan code link barcode wifi ticket deep link", defaultProps: { value: "https://example.com", label: "", size: 160 } },
  ...
  { type: "journal", label: "Reflection", glyph: "✎", category: "Trackers", defaultH: 5, description: "A calm daily prompt + your latest journal entry", keywords: "journal reflection diary gratitude prompt end of day note wellbeing mindful", defaultProps: { label: "Reflection" } },
  ...
  { type: "greeting", label: "Greeting", glyph: "☺", category: "Time", defaultH: 4, description: "Good morning / evening", keywords: "greeting hello welcome", defaultProps: { name: "", showContext: false, maxContextLength: 200 } },
  ...
  { type: "pollen", label: "Pollen", glyph: "❀", category: "Live", defaultH: 5, description: "Pollen level by family (grass / tree / weed)", keywords: "pollen allergy hay fever grass tree weed nature", defaultProps: { latitude: 28.6139, longitude: 77.209, label: "" } },
  { type: "marine", label: "Sea state", glyph: "≈", category: "Live", defaultH: 5, description: "Waves, swell and water temperature for a coastal spot", keywords: "sea marine surf waves swell tide water ocean beach", defaultProps: { latitude: 8.7, longitude: 76.7, label: "" } },
  ...
  { type: "sinceYouLooked", label: "Since you looked", glyph: "↺", category: "Time", defaultH: 4, description: "A calm digest of what changed across the board since this screen last refreshed", keywords: "since you looked what changed digest delta diff updates new recap summary changes whats new", defaultProps: { title: "Since you looked", max: 5 } },
  ...
  { type: "dailyBrief", label: "Daily Brief", glyph: "☀", category: "Time", defaultH: 9, description: "Your morning at a glance — greeting, weather, today's next events + tasks (composed from your calendar + tasks)", keywords: "daily brief morning summary today agenda digest your day standup calendar tasks", defaultProps: { title: "Today", showDate: true, showWeather: true, maxEvents: 3, maxTasks: 2 } },
...
export const INPLACE_EDIT = new Set<WidgetType>([
  "text", "heading", "subheading", "label", "callout", "banner", "code", "ascii", "lead", "ticker",
  "highlight", "aside", "mantra", "epigraph", "postscript", "finePrint", "address", "breadcrumb", "noticeBar",
