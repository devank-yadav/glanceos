// Dependency-free QR encoder (byte mode, ECC level M, versions 1–10, best-mask
// selection). Ported verbatim from apps/config — imports nothing, so it stays
// out of the zod-free screen budget. Pure → unit-tested.
